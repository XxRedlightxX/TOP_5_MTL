...
<script setup>
    ...
    const organisator = {
        ...
        desc: text,
        listEvent: [
            { image: "https://picsum.photos/1895/795", title: "Mont-Royal", desc: text, rating: 1 },
            { image: "https://picsum.photos/1891/791", title: "Vieux-Port", desc: text, rating: 3 },
            { image: "https://picsum.photos/1892/792", title: "Laronde", desc: text, rating: 5 },
            { image: "https://picsum.photos/1890/790", title: "Jardin Botanique", desc: text, rating: 4 },
            { image: "https://picsum.photos/1896/796", title: "Vieux-Port", desc: text, rating: 3 }
        ]
    };
